...
@Component ({
  ...
  template: `
    <select (change)="onChange($event.target.value)">
      ...
      <ul>
        <li (click)="isDone(currentTask)" *ngFor="let currentTask of childTaskList | completeness:filterByCompletness">{{currentTask.description}} {{currentTask.priority}}
...
export class TaskListComponent {
  filterByCompletness: string = "incompleteTasks";
